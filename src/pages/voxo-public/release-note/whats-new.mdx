...
<ul>
  ...
  <li>
    ...
    <div className="flex flex-col items-center">
      <img src="/images/whats-new/agent-pause.webp" alt="agent pause" />
  ...
  <li>
    ...
    <ul>
      <li>
        ...
        <img src="/images/whats-new/queue-manager-dashboard.png" alt="queue manager dashboard" /> 
      </li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>
    ...
    <img src="/images/whats-new/edit-call-flow.png" alt="edit call flow" />
  </li>
</ul>
      ...
      <li>
        ...
        <div className="flex flex-wrap gap-x-4">
          <div className="flex flex-col w-full max-md:basis-4/12 lg:basis-4/12">
            <div className="flex-1">
              <img src="/images/whats-new/edit-account.png" alt="edit account" className="object-contain w-full h-64" />
            </div>
            <div className="h-8">
          ...
          <div className="flex flex-col w-full max-md:basis-4/12 lg:basis-4/12">
            <div className="flex-1">
              <img src="/images/whats-new/call-outcome-report.png" alt="call outcome report" className="object-contain w-full h-64" />
            </div>
            <div className="h-8">
          ...
          <div className="flex flex-col w-full max-md:basis-4/12 lg:basis-4/12">
            <div className="flex-1">
              <img src="/images/whats-new/user-settings.png" alt="user settings" className="object-contain w-full h-64" />
            </div>
            <div className="h-8">
        ...
        <div className='flex gap-x-4'>
          <div className="flex flex-col w-full">
            <div className="flex-1">
                <img src="/images/whats-new/filter-settings.png" alt="filter settings" className="object-contain w-full h-64" />
            </div>
            <div className="h-8">
          ...
          <div className="flex flex-col">
            <div className="flex-1">
              <img src="/images/whats-new/call-records.png" alt="call records" className="object-contain w-full h-64" />
            </div>
            <div className="h-8">
...
<ul>
  <li>
    ...
    <div className="flex flex-col items-center">
      <img src="/images/whats-new/pause-resume-softphone-feature.png" alt="pause resume" />

...
## List Webhooks Types {{ tag: 'GET', label: 'https://api.voxo.co/v2/webhooks/listTypes' }}
...
## Remove A Webhook {{ tag: 'POST', label: 'https://api.voxo.co/v2/webhooks/remove' }}
...
## Update A Webhook {{ tag: 'POST', label: 'https://api.voxo.co/v2/webhooks/update' }}

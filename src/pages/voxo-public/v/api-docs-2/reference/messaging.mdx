...
<Row>
    <Col>
        ...
        <strong>Upload files to receive a back a public url</strong>
...
<Row>
    <Col>
        ...
        <div>
            <strong>IMPORTANT:</strong>
            This will not send an individual MMS to each recipient in the array. This will create a group thread with the source
        ...
        <Properties>
            ...
            <Property name="to*" type="string[]">Array of phone numbers to send the message to</Property>
            <Property name="text" type="string">The message body</Property>
            <Property name="mediaUrls" type="string[]">The string array of public urls</Property>
        </Properties>
          ...
          "createdConversations": [
            {
                ...
                "sourceDID": "16016021222",
                "participants": "16016021009,16016021222,16019122252",
                "hidden": 0,
                "name": "VOXO,16019122252",
                "conversationName": ""
            }
          ],
          "id": 4843,
...
<Row>
    <Col>
        ...
        <div>
            <strong>IMPORTANT:</strong>
            This does not delete the existing thread. The conversation is just marked as hidden in the database.
        </div>
...
<Row>
    <Col>
        ...
        <div>
            <strong>IMPORTANT:</strong>
            This endpoint will only modify the name for your <strong>your</strong> conversation. Other participants
...
<Row>
    <Col>
        ...
        <strong>Mark messages as read</strong>
        <div>
            <strong>IMPORTANT:</strong>
            This will un-hide the conversation (if it is hidden) and mark all of the messages associated with the thread as read.
        </div>
        ...
        [
          {
            ...
            "sourceDID": "16016021222",
            "participants": "12513321004,12548260127,16016021009,16016021010,16016021222,16016021344",
            "tenantId": 37,
            "hidden": 0,
            "name": "VOXO,WEST TX,VOXO,VOXO,VOXO",
...
<Row>
    <Col>
        ...
        <div>
            This is a paginated endpoint. The page default is set to 1. The recordsPerPage default is set to 100 however both of these can be changed.
            This endpoint will return the messages it finds per page and restrict the number to the recordsPerPage.
            It will return the totalMessages in the conversation, the page number the user sends, and the recordsPerPage that the user sends.
...
<Row>
    <Col>
        ...
        <div>
            This endpoint will return all of your conversations that include the phone number passed in the query params.
        </div>
        ...
        [
          {
            ...
            "sourceDID": "16016021222",
            "participants": "16016021222,16016021344,16019122252",
            "hidden": 1,
            "name": "VOXO,16019122252",
          ...
          },
          {
            ...
            "sourceDID": "16016021344",
            "participants": "16016021222,16016021344,16019122252",
            "hidden": 0,
            "name": "VOXO,16019122252",
            "conversationName": "VOXO, 6019122252"
          }
        ]
        ```
    </Col>
